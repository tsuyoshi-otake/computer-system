  ...
  },
  {
    ...
    html: `
      ...
      <section class="manual-section"><h3>2.1 Machine family</h3><div class="manual-asset-grid manual-asset-grid--machines">
        ...
        <figure class="manual-asset-card"><img src="/assets/machines/cs-portable-computer.png" width="1920" height="1920" alt="Portable Computer System laptop with trackball" loading="lazy" decoding="async"><figcaption><b>Portable Computer System</b><span>CS386SX · 16 MHz · 2 MiB · CS-DOS 1.0 · held or placed</span></figcaption></figure>
      </div></section>
...
while True:
  ...
  },
  {
    id: "dos-profile",
    html: `
      <header class="manual-page-header"><p class="manual-kicker">Chapter 14 · Computer System DOS 1.0</p><h2>Operating CS-DOS 1.0 on the CS386SX portable</h2><p class="manual-lead">Computer System DOS 1.0 (CS-DOS 1.0) is the portable profile for a CS386SX 16 MHz machine with 2 MiB RAM. It supports CS ASM 1.0, CS C/C++ 1.0, CS QBASIC 1.0, and bounded batch files. User MicroPython is unavailable. Storage, identity, execution limits, and the host security boundary remain shared with the CS-Linux desktop.</p></header>
