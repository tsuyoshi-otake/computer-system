...
ls -la /</code></pre></section>
  ...
  },
  {
    ...
    html: `
      ...
      <section class="manual-section"><h3>Production execution rate</h3><p>The Bedrock host admits approximately one hundredth of each model's persisted nominal clock: 8,000 cycles per 20 Hz tick for CS386SX 16 MHz, 16,500 for CS486DX 33 MHz, and 33,000 for CS486DX2 66 MHz. The build-validated Behavior Pack setting <code>guestRealtimeDivisor</code> controls this ratio; its shipped value is 100, while 1 requests realtime admission. Rebuild the packs and restart BDS after changing it. Instruction ceilings remain bounded safety limits. Host contention may reduce the observed rate but never increases guest timing above this admission ratio.</p></section>
