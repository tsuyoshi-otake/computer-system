...
| Connected monitor rendering and touch | supported_with_constraint | Host tests prove topology/touch mapping and bounded updates; BDS twice discovered a 3x2/51x18 surface; stable block interaction opens a DDUI fallback                                        | Use a world block frame plus DDUI terminal fallback; coalesce changed cells and cap each flush at 16 |
