...
function desktopCubes(frontMaterial) {
  return [
    ...
    cube([-7, 5, -6.5], [1, 11, 13], "case"),
    cube([6, 5, -6.5], [1, 11, 13], "case"),
    cube([-6, 5, -6.5], [12, 1.25, 13], "case"),
    cube([-6, 15.25, -6.5], [12, 0.75, 13], "case"),
    cube([-6, 6.25, -5.75], [12, 9, 12.25], "case"),
    cube([-6, 6.25, -6.75], [12, 9, 0.5], "desktop_screen"),
  ];
}
