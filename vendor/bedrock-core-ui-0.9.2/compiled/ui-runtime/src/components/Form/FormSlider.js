 ...
 */
export const FormSlider = ({ name, min, max, step, defaultValue, backgroundHover, backgroundPressed, backgroundLocked, progress, progressHover, thumb, thumbHover, thumbPressed, thumbLocked, trackHeight, thumbWidth, thumbHeight, ...layout }) => {
...
export const formSliderWriter = (payload, form, ctx, _callbacks, _props, nativeArgs) => {
    if (!isModalForm(form)) {
