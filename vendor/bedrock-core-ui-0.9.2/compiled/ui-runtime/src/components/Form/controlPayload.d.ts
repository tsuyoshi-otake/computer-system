 ...
 */
declare const FONT_TYPE_MAP: {
    readonly mojangles: "default";
    readonly minecraftTen: "MinecraftTen";
};
 ...
 */
export declare function labelFontFields(style?: LabelStyle): {
    fontType: string;
 ...
 */
export declare function labelPayloadFields(prefix: string, opts?: LabelGroupOptions): Record<string, string | number>;
export {};
