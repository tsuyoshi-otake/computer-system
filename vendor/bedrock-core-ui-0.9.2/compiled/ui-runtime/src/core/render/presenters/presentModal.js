...
import { findBackground, resolveScrolls, runInteractiveCallback } from './shared';
/**
 ...
 */
export async function presentModal(player, tree, config) {
    const context = { mode: 'modal', modalControls: new Map(), modalControlIndex: 0 };
